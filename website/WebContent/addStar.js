...
function handleResult(resultData) {
    ...
    let addstarElement = jQuery("#add_star_result");

    addstarElement.append("<b style='font-size:25px'>Adding status: " + resultData[0]["status"] + "</b>" +"<p>StarId: " + resultData[0]["new_id"] + "</p>" +
        "<p>Star Name: " + resultData[0]["starname"] + "<p>birthyear: " + resultData[0]["birthyear"] +"</p>");
}
...
jQuery.ajax({
    ...
    url: "api/addstar?starname=" + starname + "&birthyear=" + birthyear,
